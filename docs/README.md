...
3. `00_current/first_batch25_glm4_dewrap_join_measurement_20260706.md`
4. `00_current/text_gap_backfill_probe_20260706.md`
5. `00_current/table2_ipo_pre_controls_rerun_20260706.md`
6. `00_current/y_bhar_fsales_definition_audit_20260706.md`
7. `00_current/table2_data_processing_breakpoints_20260706.md`
8. `00_current/bhar_official_market_return_audit_20260706.md`
9. `00_current/fsales_growth_window_sensitivity_20260706.md`
10. `00_current/table2_listing_year_segment_controls_20260706.md`
11. `00_current/table2_existing_controls_patch_20260706.md`
12. `00_current/descriptive_comparison_vs_original_20260706.md`
13. `00_current/管理世界式_主要变量描述性统计对比_20260706.md`
14. `00_current/table2_glm4_dewrap_full543_audit_20260706.md`
15. `00_current/glm4_dewrap_join_full543_20260705.md`
16. `00_current/当前状态总结与新对话交接_20260705.md`
...
- 补抓验证显示：25 家首批科创板公司此前被旧抓取窗口漏掉，现已成功下载并抽取“业务与技术”。旧 `max_chars=4000` base 有 772 个 chunk，仅作备份；主口径已重切为 `dewrap_join + GLM tokenizer + 4000 token split`，形成 410 个 chunk 并完成 `cot_v3b_len132_tight`。
- 首批 25 家主口径补跑结果：`Summary_len_proxy` mean=122.417，`Redundancy_chunk_proxy` mean=32.278，`Text_len` mean=3809.610，Panel B Spearman rho=-0.513，低评分组冗余中位数 34.539 高于高评分组 29.459。量级可并入主 X，但由于只是首批特殊样本，结论仍标 `NO_PASS_YET`，不能当新正式 gate。
...
1. 将首批 25 家主口径 firm metrics 与 full543 合并；候选 universe 中剔除 `688688`、`688717`，并优先排除或单独标注 `688287` 转板样本。
2. 用补齐后的 universe 重新计算 X，再判断如何从 565/566 对齐到原文 552。
3. 定向下载 CSMAR 成长能力/财务指标分析中的营业收入增长率，以及市场调整年个股回报率或持有期超额收益字段。
4. `BHAR` 保留 365 自然日 + 剔除首日 + STAR 等权作为候选；`FSales_Growth` 暂保留当前 `L -> L+1` 作为最贴分布候选，不继续盲目扩窗口。
