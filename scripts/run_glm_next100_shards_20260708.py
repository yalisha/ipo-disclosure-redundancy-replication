...
def main() -> None:
    ...
    for shard in SHARDS:
        source = f"glm4_dewrap_join_glm_next100_table2_shard{shard}_{DATE_TAG}"
        run = f"siliconflow_glm4_32b_table2_next100_shard{shard}_{DATE_TAG}"
