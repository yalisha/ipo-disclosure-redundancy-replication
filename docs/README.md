...
1. `00_current/glm471_table2_strict_master_20260708.md`
2. `00_current/glm471_table2_bhar_fsales_waterfall_20260708.md`
3. `00_current/siliconflow_glm4_32b_glm471_20260708.md`
4. `00_current/glm_table2_strict_master_20260708.md`
5. `00_current/glm300_table2_gate_20260708.md`
6. `00_current/siliconflow_glm4_32b_glm300_20260708.md`
7. `00_current/siliconflow_glm4_32b_table2_next100_after200_20260708.md`
8. `00_current/glm_remaining_to471_table2_source_20260708.md`
9. `00_current/glm_next100_after200_table2_source_20260708.md`
10. `00_current/glm200_table2_gate_20260708.md`
11. `00_current/siliconflow_glm4_32b_glm200_20260708.md`
12. `00_current/siliconflow_glm4_32b_table2_next100_20260708.md`
13. `00_current/glm_next100_table2_source_20260708.md`
14. `00_current/siliconflow_glm4_32b_glm100_20260707.md`
15. `00_current/siliconflow_glm4_32b_table2_next50_20260707.md`
16. `00_current/glm_next50_table2_source_20260707.md`
17. `00_current/glm_only_replication_hypothesis_20260707.md`
18. `00_current/summary_diagnostic_x_table2_20260707.md`
19. `00_current/summary_denominator_right_tail_repair_probe_20260707.md`
20. `00_current/sample552_tailmerge_threshold_probe_20260707.md`
21. `00_current/glm50_tailmerge_floor_candidate_gate_20260707.md`
22. `00_current/glm50_processing_descriptive_sweep_20260707.md`
23. `00_current/siliconflow_glm4_32b_pilot50_measurement_20260707.md`
24. `00_current/siliconflow_glm4_32b_pilot50_20260707.md`
25. `00_current/siliconflow_glm4_32b_pilot5_measurement_20260707.md`
26. `00_current/siliconflow_glm4_32b_pilot5_20260707.md`
27. `00_current/cutoff552_table2_471_probe_20260707.md`
28. `00_current/candidate566_x_universe_after_first_batch_20260707.md`
29. `00_current/table2_candidate566_ipo_pre_controls_20260707.md`
30. `00_current/sample_and_ready_y_fields_audit_20260706.md`
31. `00_current/first_batch_25firm_measurement_runbook_20260706.md`
32. `00_current/first_batch25_glm4_dewrap_join_measurement_20260706.md`
33. `00_current/text_gap_backfill_probe_20260706.md`
34. `00_current/table2_ipo_pre_controls_rerun_20260706.md`
35. `00_current/y_bhar_fsales_definition_audit_20260706.md`
36. `00_current/table2_data_processing_breakpoints_20260706.md`
37. `00_current/bhar_official_market_return_audit_20260706.md`
38. `00_current/fsales_growth_window_sensitivity_20260706.md`
39. `00_current/table2_listing_year_segment_controls_20260706.md`
40. `00_current/table2_existing_controls_patch_20260706.md`
41. `00_current/descriptive_comparison_vs_original_20260706.md`
42. `00_current/管理世界式_主要变量描述性统计对比_20260706.md`
43. `00_current/table2_glm4_dewrap_full543_audit_20260706.md`
44. `00_current/glm4_dewrap_join_full543_20260705.md`
45. `00_current/当前状态总结与新对话交接_20260705.md`
...
- GLM remaining-to-471 的 6 个 shard 已全部跑完并聚合，chunk 数分别为 525、511、492、419、400、386；新增 GLM471 合并诊断：`00_current/siliconflow_glm4_32b_glm471_20260708.md`。
- GLM471 最佳候选为 `proxy_tailmerge1500_floor50`。合并测度池 firm=483、chunk=7850；接回 Table2 后 strict master firm=471。
- GLM471 strict Table2：`00_current/glm471_table2_strict_master_20260708.md`。`paper_exact_ipo_pre_fin_fe` 下 `FInvention` coef=-0.0351, t=-1.863, p=0.062；`BHAR` coef=-0.0120, p=0.206；`FSales_Growth` coef=0.0156, p=0.340。
- GLM471 BHAR/FSales waterfall：`00_current/glm471_table2_bhar_fsales_waterfall_20260708.md`。BHAR 从 x-only 到 full controls 均为负但不显著；FSales_Growth 从 x-only 起就是正，缩尾和 controls 没有修复方向。
...
- GLM471 合并诊断已完成：合并测度池为 483 家、7850 个原始 chunk；接 Table2 后为 471 家。最佳候选为 `proxy_tailmerge1500_floor50`：chunk=7671，`Text_len` mean/std=3880.512/344.583，`Summary_len` mean/std=127.556/44.101，`Redundancy_chunk` mean/std=33.142/10.370，企业层 `Redundancy` mean/std=30.512/2.571。原文对应均值分别为 `Text_len=3866.817`、`Summary_len=132.678`、`Redundancy_chunk=32.176`、`Redundancy=29.074`。
- GLM471 Panel B 方向成立但仍弱：主候选下 rho=-0.102, p<0.001；低评分组 `Redundancy_chunk` 中位数 32.357 高于高评分组 30.988，满足正向判据。Panel C rho=0.054；Panel D rho=-0.258。
- GLM471 strict Table2 的结论是：`FInvention` 与原文最接近，`paper_exact_ipo_pre_fin_fe` 下 coef=-0.0351, t=-1.863, p=0.062；`BHAR` 方向正确但不显著，coef=-0.0120, t=-1.265, p=0.206；`FSales_Growth` 仍方向错误，coef=0.0156, t=0.954, p=0.340。GLM471 已基本排除“只是 X measurement 样本没跑够”这一解释。
...
不要把机械 cap 版 X 定为正式变量，也不要继续围绕 Codex 摘要分母反复贴表。GLM471 后，扩样本身已经不能解释 `BHAR / FSales_Growth` 不复刻；X measurement 可以作为“弱通过”进入下一阶段，但 Table2 仍是 `NO_PASS_YET`：

1. 固定 GLM 流程候选：`THUDM/GLM-4-32B-0414 + dewrap_join/GLM tokenizer chunk + Summary_len_proxy + tail_merge<1500 + summary_floor=50`；保留 `1600/1700` 作为敏感性。
2. 停止继续把主精力放在 X 调参；优先核对原文 `BHAR` 精确定义、市场基准、首日处理、持有窗口和 CSMAR 是否已有现成持有期超额收益字段。
3. 优先核对 `FSales_Growth` 是否来自 CSMAR 成长能力现成字段、是否做了异常值处理、是否采用招股前财务口径或上市后第一个完整年度窗口；当前自构造口径方向与原文相反。
4. 将 `list_date_csmar < 2023-08-15` 作为候选 Table 1 firm-level cutoff 写入样本制度，并保留 `688475`、`688496`、`688525` 作为 Table 2 年末窗口排除候选。
5. 只有在 Y 口径复核后仍需要，才补 552 家 Table 1 cutoff 的 GLM X；否则不要用继续扩 GLM 样本替代 Y 复核。
